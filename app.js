...
const store = new MongoDBStore({
  uri: `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.vjikf.mongodb.net/chat-fake-zalo`,
...
app.use((req, res, next) => {
  res.locals.title = 'Welcome to Chat Fake Zalo';
...
mongoose
  .connect(
    `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.vjikf.mongodb.net/chat-fake-zalo`,
